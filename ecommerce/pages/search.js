...
const prices = [
  {
    name: 'Below 10.000.000 VND',
    value: '0-10000000',
  },
  {
    name: '10.000.000 VND to 20.000.000 VND',
    value: '10000000-20000000',
  },
  {
    name: '20.000.000 VND to 30.000.000 VND',
    value: '20000000-30000000',
  },
  {
    name: '30.000.000 VND to 40.000.000 VND',
...
export default function Search(props) {
  ...
  const addToCartHandler = async (product) => {
    const existItemId = cartItemIds.find(
      (cartItemId) => cartItemId === product._id
    );

    const quantity = existItemId
      ? cartItemIds.filter((cartItemId) => cartItemId === existItemId).length +
        1
      : 1;
...
export async function getServerSideProps({ query }) {
  ...
  const products = productDocs.map(db.convertMongoDocToObject);
